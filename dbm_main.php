...
<html>
  ...
  <body>
    ...
    <table align = "center">
      <tr>
        <td style = "margin:20px; padding:20px; color:#2b3770; background-color:#b1bfcc"> <a href="DBM_FinalPresentation.pdf"> Presentation </a> </td>
        <td style = "margin:20px; padding:20px; color:#2b3770; background-color:#b1bfcc"> <a href="Stage6_jms590.docx"> Final Report </a> </td>
      </tr>
    </table>
