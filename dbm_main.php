    ...
    <table align = "center">
        <tr>
          <form action="" method="post">
              <td> <label style = "margin:10px; padding:10px"> Username: </label> <input id="ip2" type="text" name="username" value="<?php echo htmlentities($username); ?>" style = "margin:10px; padding:2px"> </td>
              <td> <label style = "margin:10px; padding:10px"> Password: </label> <input id="ip2" type="text" name="password" value="<?php print($password); ?>" style = "margin:10px; padding:2px"> </td>
